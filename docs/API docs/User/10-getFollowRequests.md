...
This function allows you to get all the pending follow requests that your account has received.
...
```javascript
const response = await axios.get("https://daykeeper.life/follow_requests")
```
