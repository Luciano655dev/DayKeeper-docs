...
### <span style={{color: 'darkgreen'}}>GET</span> `/:name/:title/likes`

#### Description:

This function allows you to get the information about the users who liked a post.
...
const response = await axios.get(
  "https://daykeeper.life/JohnDoe/25-08-2024/likes"
)
```
